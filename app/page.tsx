...
export default function Home() {
  ...
  useEffect(() => {
    ...
    tmdb.get("/genre/movie/list").then((res: { data: { genres: Genre[] } }) => {
          ...
          <div className="flex justify-between items-center">
            ...
            <div className="flex gap-3 relative">
              ...
              <div
                ...
                className="absolute right-0 duration-300 p-5 bg-white border border-[#E4E4E7] rounded-lg mt-12 z-50 data-[shown=true]:visible data-[shown=true]:opacity-100 invisible opacity-0"
              >
        ...
        <SwiperSlide>
          <div className="h-150 flex items-center relative">
            <Image
              ...
              priority
            />
            <div className="container mx-auto pl-15 relative bg-transparent z-10">
